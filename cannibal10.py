...
cl = LineClient("ratuamor30@gmail.com","ratu2341")
...
ki = LineClient("rismashelina499@gmail.com","risma2341")
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki,ki.server.CHANNEL_ID['LINE_TIMELINE'])
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))


kk = LineClient("agustinshelina25@gmail.com","agustin2341")
...
owner = ["u0a5ea53cd427b18faf9b3d2d1504ca4f"]
admin = ["u0a5ea53cd427b18faf9b3d2d1504ca4f"]
staff = ["u0a5ea53cd427b18faf9b3d2d1504ca4f"]
...
#KICKALL
                          ...
                          if msg._from in admin:
                           ...
                           if msg._from in Bots:
                            if msg.toType == 2:
                             #  print "Otw cleanse"
                               _name = msg.text.replace("Rusuh","Bubar")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               kb.sendMessage(msg.to, "╚⚕️SIAP NDAAN╗\n╚CANNIBAL™️╮╗".format(str(elapsed_time)))
                               kd.sendMessage(msg.to, "╚⚕️SIAP NDAAN╗\n╚CANNIBAL™️╮╗".format(str(elapsed_time)))
                               ke.sendMessage(msg.to, "╚⚕️SIAP NDAAN╗\n╚CANNIBAL™️╮╗".format(str(elapsed_time)))
                               kf.sendMessage(msg.to, "╚⚕️SIAP NDAAN╗\n╚CANNIBAL™️╮╗".format(str(elapsed_time)))
                               kj.sendMessage(msg.to, "╚⚕️SIAP NDAAN╗\n╚CANNIBAL™️╮╗".format(str(elapsed_time)))
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 1")
                                ki.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 2")
                                kk.sendMessage(msg.to, "[☯️ PAAUKAN CANNIBAL™️ 3")
                                kc.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 4")
                                kb.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 5")
                                kd.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 6")
                                ke.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 7")
                                kf.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 8")
                                kj.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 9")
                                sw.sendMessage(msg.to, "[☯️ PASUKAN CANNIBAL™️ 10")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                cl.sendText(msg.to, "Bye CANNIBAL™️ Pulang Duluan   "+str(G.name))
...
#===========Hiburan============#
                        ...
                        elif cmd == "ckbot" or cmd == "canbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "Pasukan Hadir")
                                ki.sendMessage(msg.to, "Pasukan Hadir")
                                kk.sendMessage(msg.to, "Pasukan Hadir")
                                kc.sendMessage(msg.to, "Pasukan Hadir")
                                kb.sendMessage(msg.to, "Pasukan Hadir")
                                kd.sendMessage(msg.to, "Pasukan Hadir")
                                ke.sendMessage(msg.to, "Pasukan Hadir")
                                kf.sendMessage(msg.to, "Pasukan Hadir")
                                kj.sendMessage(msg.to, "Pasukan Hadir")
                                sw.sendMessage(msg.to, "Pasukan Hadir")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                Ticket = cl.reissueGroupTicket(msg.to)
                                ki.acceptGroupInvitationByTicket(msg.to,Ticket)
                                ki.sendMessage(msg.to, "CANNIBAL™️ Masuk di "+str(G.name))
                                kk.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kk.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                kc.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kc.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                kb.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kb.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                kd.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kd.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                ke.acceptGroupInvitationByTicket(msg.to,Ticket)
                                ke.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                kf.acceptGroupInvitationByTicket(msg.to,Ticket)
                                kf.sendMessage(msg.to, "CANNIBAL™️ Masuk di"+str(G.name))
                                G = cl.getGroup(msg.to)
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                                ki.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                ki.leaveGroup(msg.to)
                                kk.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                kk.leaveGroup(msg.to)
                                kc.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                kc.leaveGroup(msg.to)
                                kb.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                kb.leaveGroup(msg.to)
                                kd.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                kd.leaveGroup(msg.to)
                                ke.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                ke.leaveGroup(msg.to)
                                kf.sendMessage(msg.to, "CANNIBAL™️ Pamit ya "+str(G.name))
                                kf.leaveGroup(msg.to)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                    cl.sendMessage(msg.to,"Tidak ada penjahat")
                                    ki.sendMessage(msg.to,"Tidak ada penjahat")
                                    kk.sendMessage(msg.to,"Tidak ada penjahat")
                                    kc.sendMessage(msg.to,"Tidak ada penjahat")
                                    kb.sendMessage(msg.to,"Tidak ada penjahat")
                                    kd.sendMessage(msg.to,"Tidak ada penjahat")
                                    ke.sendMessage(msg.to,"Tidak ada penjahat")
                                    kf.sendMessage(msg.to,"Tidak ada penjahat")
                                    kj.sendMessage(msg.to,"Tidak ada penjahat")
                                    sw.sendMessage(msg.to,"Tidak ada penjahat")
                              else:
                                    ma = ""
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              ...
                              cl.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              ki.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kk.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kc.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kb.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kd.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              ke.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kf.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              kj.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
                              sw.sendMessage(msg.to,"Sukses membersihkan penjahat " +mc)
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttp://line.me/ti/p/D")
                        ...
                        elif cmd == "botdk-bot" or cmd == "cnbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[☯️CANNIBAL™️].")
                               elapsed_time = time.time() - start
